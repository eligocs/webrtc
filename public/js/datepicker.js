(function(window, $, undefined) {
    (function() {
        var VERSION = "2.2.3",
            eventDates = attendedLectureDates,
            ...
            defaults = {
                ...
                multipleDatesSeparator: "<em>To</em>",
                range: false,
                ...
                onRenderCell: function(date, cellType) {
                    ...
                    if (
                        cellType == "day" &&
                        eventDates.indexOf(currentDate1) != -1 &&
                        new Date(currentDate1) < new Date()
                    ) {
                        return {
                            html:
                                currentDate +
                                '<div class="fc-content present"><span class="fc-attendance">P</span> </div>'
                        };
                    } else {
                        if (
                            absentLectureDates.indexOf(currentDate1) != -1 &&
                            new Date(currentDate1) < new Date()
                        ) {
                            return {
                                html:
                                    currentDate +
                                    '<div class="fc-content absent"><span class="fc-attendance">A</span> </div>'
                            };
                        }
                        if (
                            notAvailable.indexOf(currentDate1) != -1 &&
                            new Date(currentDate1) < new Date()
                        ) {
                            return {
                                html:
                                    currentDate +
                                    '<div class="fc-content not-available"><span class="fc-attendance">NA</span> </div>'
                            };
                        }
                    }
                }
