      ...
      <tbody>
        ...
        <tr>
          ...
          <td>
            ...
            title="It will delete the answer sheet of this student" href="#" class="btn btn-sm btn-theme">
            Reset Response
            </a> --}}
            ...
            <div class="modal-dialog modal-sm">
              <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                  ...
                  'iacsId' => request()->iacsId, 'all_report' => $answer->id, 'topicid' => $topic->id, 'userid' =>
                  $student->id] ]) !!}
