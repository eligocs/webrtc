            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                    ...
                    <div class="text-center">
                        <h5 class="headinghem"> Please Create A New Password Before Login</h5>
                    </div>
                    <div class="card">
                        <!--phone no div--->
                        <div class="card" id="phone">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center mb-4">
                                    <h4 class="text-uppercase mt-0">Click to generate otp</h4>
                                </div>
                                ...
                                <form action="#" id="forgotPasswordForm" method="post">
                                    ...
                                    <input type="text" class="form-control" placeholder="Phone Number" name="phone"
                                        id="forgotPasswordPhone" value="{{ $phno }}"
                                        onkeyup="this.value.length>10?this.value = this.value.substring(0, 10): ''"
                                        required readonly>
                                    <br>
                                    <div class="alert alert-danger errResponse" style="display:none;"></div>
                                    <div class="form-group mb-0 text-center">
                                        <button id="forgotPasswordButton" class="btn btn-theme w-100 btn-block"
                    ...
                    <div class="card" id="otp">
                        <div class="card-body p-4">
                            ...
                            <form id="verify_otp_form">
                                <div class="wrapper">
                                    <div class="otp-form">
                                        <input class="digit" type="text" name="digit1" id="digit1"
                                            data-next="digit2" maxlength="1" min="0" max="9" />
                                        <input type="text" name="digit2" id="digit2" class="digit"
                                            data-next="digit3" maxlength="1" data-previous="digit1" min="0" max="9" />
                                        <input type="text" class="digit" id="digit3" name="digit3"
                                            data-next="digit4" maxlength="1" data-previous="digit2" min="0" max="9" />
                                        <input type="text" class="digit" id="digit4" name="digit4"
                                            data-next="digit5" maxlength="1" data-previous="digit3" min="0" max="9" />
                                        <input type="text" class="digit" id="digit5" name="digit5"
                                            data-next="digit6" maxlength="1" data-previous="digit4" min="0" max="9" />
                                        <input type="text" class="digit" id="digit6" name="digit6"
                                            data-next="digit7" maxlength="1" data-previous="digit5" min="0" max="9" />
                                    </div>
                                    <span class="input-group-text text-white bg-color-main resnd-otp" id="basic-addon1"
                                        style="cursor: pointer;"><img
                                            src="{{ URL::to('assets/front/images/tool.png') }}">Resend
                                        22</span>
                                    <ul class="clearfix">
                                    ...
                                    <div class="alert alert-success otpSuccessResponse" style="display:none;">
                                    </div>
                                    <button class="btn btn-theme w-100 btn-block" id="verify_otp_submit"
                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="#" id="resetPasswordForm" method="post">
                                ...
                                <div class="wrapper mx-auto">
                                    ...
                                    <input type="password" placeholder="Password" id="fpassword" name="password"
                                        required>
                                    <input type="password" placeholder="Confirm Password" id="fconfirm_password"
                    ...
                    <input type="hidden" id="verify_otp_post_url"
                        value="{{ route('front.student.signup.verify_otp') }}" />
                    <!-------------------------forget pasword---------------------------------->
        ...
        $(document).ready(function() {
            ...
            $('#forgotPasswordForm').submit(function(e) {
                ...
                function submitResetPasswordForm(form) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "{{ route('front.student.signup.reset_password_institute_url') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            "phone": phone_number,
                            "password": password,
                        ...
                        success: function(data) {
                            if (data.status == 'Success') {
                                $('#resetPasswordConfirmationMessage').text(
                                ...
                                $.each(data.error, function(key, value) {
                                    jQuery('.errResponse').show();
                                    jQuery('.errResponse').append('<p>' + value +
                                        '</p>');
                                });
                            }
                        }
                        ...
                        success: function(data) {
                            ...
                            if (data.status == 'Success') {
                                ...
                                if (otp_for == 'forgotPassword') {
                                    ...
                                    $('.otpSuccessResponse').html(
                                        '<p>Otp has been verified.</p>');
                                    ...
                                    $('.otpSuccessResponse').html(
                                        '<p>Otp has been verified. Please do login now.</p>'
                                    );
