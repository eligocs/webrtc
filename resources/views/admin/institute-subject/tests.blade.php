...
{{-- <div id="createModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      {!! Form::open(['method' => 'POST', 'action' => ['Web\Institute\TopicController@store', request()->iacs_id]])
      !!}
...
{!! Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Test Title',
'required' => 'required']) !!}
...
<div class="form-group{{ $errors->has('timer') ? ' has-error' : '' }}">
  ...
  {!! Form::number('timer', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Test Total Time
  (In Minutes)']) !!}
...
<div class="col-md-6">
  <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
    ...
    {!! Form::textarea('description', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Test
    Description', 'rows' => '8']) !!}
...
{{-- <div>{{ Breadcrumbs::render('tests', request()->iacs_id) }}</div> --}}
<div class="row">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                    ...
                    <span class="required">*</span>
                    {!! Form::text('title', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Test
                    Title',
                    'required' => 'required']) !!}
                    <small class="text-danger">{{ $errors->first('title') }}</small>
                  </div>
                  ...
                  <div class="form-group{{ $errors->has('timer') ? ' has-error' : '' }}">
                    {!! Form::label('timer', 'Test Time (in minutes)') !!}
                    {!! Form::number('timer', null, ['class' => 'form-control', 'placeholder' => 'Please Enter Test
                    Total Time
                    (In Minutes)']) !!}
                    <small class="text-danger">{{ $errors->first('timer') }}</small>
                  </div>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          ['Web\Institute\TopicController@destroy', request()->iacs_id,
          $topic->id]]) !!}
  ...
  <div class="d-flex flex-wrap justify-content-center">
    {{-- <a href="{{route('institute.questions.show', [request()->iacs_id, $topic->id])}}"
...
<div id="deleteans{{ $topic->id }}" class="delete-modal modal fade" role="dialog">
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <h4 class="modal-heading">Are You Sure ?</h4>
        <p>Do you really want to delete these Test Answer Sheet? This process cannot be undone.</p>
      </div>
      <div class="modal-footer">
        {!! Form::open(['method' => 'DELETE', 'action' => ['Web\Institute\TopicController@deleteperquizsheet',
        request()->iacs_id, $topic->id]]) !!}
        {!! Form::reset("No", ['class' => 'btn btn-gray', 'data-dismiss' => 'modal']) !!}
        {!! Form::submit("Yes", ['class' => 'btn btn-danger']) !!}
        {!! Form::close() !!}
