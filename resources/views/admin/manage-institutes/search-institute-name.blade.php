...
<div class="content">
    <div class="">
        <div class="page-header-title">
            <h4 class="page-title">Manage Institutes @if(isset($institutes)) ({{count($institutes)}})@endif</h4>
                                        ...
                                        <div class="col-12">
                                            <ul class="list-inline menu-left mb-md-5 d-md-flex justify-content-start manage-search">
                                                <li class=" app-search float-left mr-md-3 mb-2">
                                                    <form role="search" class="position-relative" action="{{route('admin.manage-institutes.search.institute_name')}}" >
                                                ...
                                                <table class="table table-hover mb-0 manage-table">
                                                    ...
                                                    @if(isset($institutes))
                                                        ...
                                                        @foreach ($institutes as $institute)
                                                            <tr>
                                                                <th>{{$institute_counter}}.</th>
                                                                <td> 
                                                                    <span class="text-pale-sky text-capitalize">{{$institute->name}}</span><p>Id : {{$institute->id}}</p>
                                                                </td>
                                                                <td>Total Enrollments 300</td>
                                                                <td> Classes - 2</td>
                                                            <td><a href="{{route('admin.manage-institutes.view-institute',$institute->id)}}" class="text-theme">View</a></td>
                                                            </tr>  
                                                            @php
                                                            $institute_counter++;    
                                                        @endphp
